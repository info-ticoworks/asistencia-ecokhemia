...
<html lang="es">
    ...
    <body>
        <form action="frmRecuperarContraseña.php" class="form-box" method ="POST"> 
            ...
            if (isset($_POST['btGuardar'])) {
                ...
                icon: 'error',
                title: 'Oops...!',
                text: 'Debe dijitar todos los Datos.',  
                })
                </script>";
                } else {
                ...
                text: 'La contraseña debe tener un minimo de 8 caracteres..!',  
                    ...
                    if ($new == $conf) {
                        $conexion = new mysqli("localhost", "id18076146_admin", "DaJoDaJoJe_2021", "id18076146_colaboradores");
